			...
			{land ? (
				<div>
					<div className="">
						...
						<p>
							Status: <span>{land.status}</span>
						</p>
						<p className=" mb-1">
							Price:{" "}
							<span>
								{parseFloat(land.price.$numberDecimal).toLocaleString("en-US")}
							</span>
						</p>
						<p className=" mb-1">
							Location: <span>{land.location}</span>
						</p>
						<div>
							<p>
								plots: <span>{land.plots}</span>
							</p>
							<p>
								docType: <span>{land.docType}</span>
							</p>
							<p>
								ownershipType: <span>{land.ownershipType}</span>
							</p>
							<div>
								<img src={""} alt="" />
							</div>
					...
					<div className=" flex justify-start items-start gap-4 my-4 relative">
						...
						<button
							...
							<span className=" max-sm:hidden md:block">Delete Land</span>
							<span className=" md:hidden max-sm:block">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									height="28px"

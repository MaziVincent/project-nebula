	...
	return (
		<div className="w-full h-auto max-md:pt-12">
			<div className=" bg-gray-50 w-full ">
				<h1 className=" text-3xl font-bold p-1 text-gray-700">Dashboard</h1>
			</div>
			<div className="flex justify-center gap-4 items-center flex-wrap">
				<div className="shadow-lg rounded-lg bg-emerald-500 text-gray-100 w-28 max-sm:w-56">
					<div className=" flex justify-between flex-col items-center p-2">
						<span>
							{" "}
							<Apartment sx={{ color: grey[100] }} fontSize="large" />{" "}
						</span>
						<span className=" text-2xl font-bold flex flex-col-reverse items-center">
							{" "}
					...
					<Link
						to="/admin/apartments"
						className="text-sm text-center font-lifght bg-gray-100 block rounded-b-lg hover:text-emerald-500">
						{" "}
						View Details
						<span>
				...
				<div className="shadow-lg rounded-lg bg-sky-500 text-gray-100 w-28 max-sm:w-56">
					<div className=" flex justify-between flex-col items-center p-2">
						<span>
							{" "}
							<Store sx={{ color: grey[100] }} fontSize="large" />{" "}
						</span>
						<span className=" text-2xl font-bold flex flex-col-reverse items-center">
							{" "}
							{propertyCounts.shops}
					...
					<Link
						to="/admin/shops"
						className="text-sm text-center font-lifght bg-gray-100 block rounded-b-lg hover:text-sky-500">
						{" "}
						View Details
						<span>
							<ArrowRightAlt fontSize="" />
				...
				<div className="shadow-lg rounded-lg bg-orange-500 text-gray-100 w-28 max-sm:w-56">
					<div className=" flex justify-between flex-col items-center p-2">
						<span>
							{" "}
							<House sx={{ color: grey[100] }} fontSize="large" />{" "}
						</span>
						<span className="text-2xl font-bold flex flex-col-reverse items-center">
							{" "}
							{propertyCounts.houses}
					...
					<Link
						to="/admin/houses"
						className="text-sm text-center font-lifght bg-gray-100 block rounded-b-lg hover:text-orange-500">
						{" "}
						View Details
						<span>
							<ArrowRightAlt fontSize="" />
				...
				<div className="shadow-lg rounded-lg bg-yellow-500 text-gray-100 w-28 max-sm:w-56">
					<div className=" flex justify-between flex-col items-center p-2">
						<span>
							{" "}
							<Landscape sx={{ color: grey[100] }} fontSize="large" />{" "}
						</span>
						<span className=" text-2xl font-bold flex flex-col-reverse items-center">
							{" "}
							{propertyCounts.lands}
					...
					<Link
						to="/admin/lands"
						className="text-sm text-center font-lifght bg-gray-100 block rounded-b-lg hover:text-yellow-500">
						{" "}
						View Details
						<span>
							<ArrowRightAlt fontSize="" />
			...
			<div className=" pt-4 pb-2 ">
				<h2 className=" text-2xl text-center text-gradient">
					Recent Properties
				</h2>
			</div>

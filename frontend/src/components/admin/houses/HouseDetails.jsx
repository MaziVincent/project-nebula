				...
				<div>
						...
						<div>
							...
							<p className=" clear-start mb-1">
								...
								<span className=" text-gray-600">
									&#8358;
									{parseFloat(house.price.$numberDecimal).toLocaleString(
										"en-US"
									)}
								</span>
							</p>
							<p className="">
								Location:{" "}
								<span className=" text-gray-700">{house.location}</span>
							</p>
							<div className=" grid grid-cols-6 max-md:grid-cols-4 gap-y-8 max-sm:grid-cols-2 w-11/12">
								<p className=" border-r-2 border-gray-500 text-gray-600 p-2 m-0 pl-0 flex flex-col items-center">
									Bedrooms: <span>{house.bedrooms}</span>
								</p>
								<p className=" border-r-2 border-gray-500 text-gray-600 p-2 m-0 pl-0 flex flex-col items-center max-sm:border-r-0">
									Bathrooms: <span>{house.bathrooms}</span>
								</p>
								<p className=" border-r-2 border-gray-500 text-gray-600 p-2 m-0 pl-0 flex flex-col items-center">
									squareFootage: <span>{house.squareFootage}ft</span>
								</p>
								<p className=" border-r-2 border-gray-500 text-gray-600 p-2 m-0 pl-0 flex flex-col items-center max-sm:border-r-0">
									yearBuilt: <span>{house.yearBuilt}</span>
								</p>
								<p className=" border-r-2 border-gray-500 text-gray-600 p-2 m-0 pl-0 flex flex-col items-center">
					...
					<div className=" flex justify-start items-start gap-4 my-4 relative">
						...
						<button
							...
							<span className=" max-sm:hidden md:block">Delete House</span>
							<span className=" md:hidden max-sm:block">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									height="28px"
							...
							{isUpload && (
								<div className="absolute flex flex-col justify-start items-start  gap-3 w-20 bg-sky-100 rounded-lg bottom-[50px] shadow-xl">
									<button
										...
										<span className=" font-semibold px-2">House Image</span>
									</button>

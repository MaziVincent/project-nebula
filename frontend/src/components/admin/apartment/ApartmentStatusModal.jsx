...
const ApartmentStatusModal = ({ openStatus, handleCloseStatus, apartment }) => {
	...
	return (
		<Modal
			...
			<div className=" py-4 px-4 bg-white relative rounded-xl ">
				<ToastContainer />
				<h1 className="text-2xl font-bold">Update Apartment Status</h1>
...
export default React.memo(ApartmentStatusModal);

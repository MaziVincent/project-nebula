				...
				<div>
					<div className=" grid">
						...
						<p className=" mb-1">
							...
							<span className=" text-gray-600 font-medium">
								{parseFloat(apartment.price.$numberDecimal).toLocaleString(
									"en-US"
								)}
							</span>
						</p>
						...
						<div className="grid grid-cols-3  gap-y-8 max-sm:grid-cols-2 w-3/4 max-sm:w-full">
							<p className="border-r-2 border-gray-500 text-gray-600  m-0 pl-0 flex flex-col items-center max-sm:justify-start">
								Bedrooms: <span>{apartment.bedrooms}</span>
							</p>
							<p className="border-r-2 border-gray-500 text-gray-600  m-0 pl-0 flex flex-col items-center">
								Bathrooms: <span>{apartment.bathrooms}</span>
							</p>
							<p className=" text-gray-600  m-0 pl-0 flex flex-col items-center">
								Floor Area: <span>{apartment.floorArea}</span>
							</p>
						</div>
						<div>
								...
								{apartment?.exteriorFeatures && (
									<div className=" my-5">
										...
										<ul className="grid grid-cols-1 md:gridcols2 lg:grid-cols-4 gap-4 max-md:space-x-0 max-md:space-y-8">
											{apartment.exteriorFeatures.map((feature, index) => (
												<li
													key={index}
					...
					<div className=" flex justify-start items-start gap-4 my-4 ">
						...
						<button
							...
							<span className=" max-sm:hidden md:block">Delete Apartment</span>
							<span className=" md:hidden max-sm:block">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									height="48px"

...
const Contact = () => {
	return (
		<div>
			<SEO
				title="Contact Us - Get in Touch with MegaTech RealEstate"
				description="Contact MegaTech RealEstate for property inquiries, support, and real estate services. Visit our offices in Abakaliki, Ebonyi State."
				keywords="contact real estate, MegaTech contact, property inquiry, Abakaliki office"
			/>
			{/* start page title  */}
				...
				<div className="container-fluid">
					<div className="row">
						<div className="col-12 p-0 position-relative">
							...
							<div
								className="alt-font fw-600 fs-350 lg-fs-275 md-fs-250 sm-fs-200 xs-fs-140 ls-minus-5px xs-ls-minus-2px position-absolute right-minus-50px lg-right-minus-0px bottom-minus-80px md-bottom-minus-60px xs-bottom-minus-40px text-white text-outline text-outline-width-3px"
				...
				<div className="container">
					<div className="row justify-content-center align-items-center">
						<div className="col-lg-6 pt-8 pb-8 text-center text-sm-start">
							<h6 className="alt-font fw-700 text-dark-gray mb-15px">
								Abakaliki
							</h6>
							<div className="row row-cols-1 row-cols-sm-2 mb-10">
								<div className="col last-paragraph-no-margin xs-mb-20px">
									<span className="fs-18 alt-font fw-600 d-block text-dark-gray mb-5px">
										Main Office
									</span>
									<p className="w-80 lg-w-100">
										First Floor, Ebonyi State Shopping Mall,
										<br /> Abakaliki, Ebonyi State
									</p>
								</div>
								<div className="col">
									<span className="fs-18 alt-font fw-600 d-block text-dark-gray mb-5px">
									...
									<a href="tel:12345678910">07046047536</a>
									<br />
									<a
						...
						<div className="col-lg-6 align-self-start contact-form-style-03 position-relative">
							<div className="bg-white box-shadow-double-large p-12 lg-p-9 border-radius-10px">
								<h3 className="fw-700 alt-font text-dark-gray mb-30px sm-mb-20px">
									How can help you?
								</h3>
								{/* start contact form  */}
								<form action="email-templates/contact-form.php" method="post">
									<div className="position-relative form-group mb-20px">
										<span className="form-icon text-medium-gray opacity-6">
											<i className="bi bi-emoji-smile"></i>
										</span>
										<input
											className="ps-0 border-radius-0px bg-transparent border-color-extra-medium-gray form-control required"
											type="text"
											name="name"
									...
									<div className="position-relative form-group mb-20px">
										<span className="form-icon medium-gray opacity-6">
									...
									<div className="position-relative form-group mb-20px">
										...
										<input
											className="ps-0 border-radius-0px bg-transparent border-color-extra-medium-gray form-control"
											type="tel"
											name="phone"
									...
									<div className="position-relative form-group form-textarea mt-15px mb-0">
										...
										<button
											className="btn btn-medium btn-base-color btn-round-edge mt-35px submit fw-600"
											type="submit">
											Send message
										</button>
							...
							<div className="col icon-with-text-style-01 md-mb-40px">
								<div className="feature-box feature-box-left-icon-middle last-paragraph-no-margin">
									...
									<div className="feature-box-content">
										<span className="d-inline-block fs-19 lh-26 alt-font text-dark-gray fw-600 w-75 lg-w-100">

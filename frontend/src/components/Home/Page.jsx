...
import megalogo from "../../assets/images/nebula/nebula-logo.png";
import megaflier from "../../assets/images/photos/new-est.png";
...
const Page = () => {
	...
	return (
		<div className=" mt-10">
			<SEO
				title="Nebula RealEstate - Find Your Dream Property in Nigeria"
				description="Discover the best properties for sale and rent in Nigeria. Browse houses, apartments, lands, and commercial properties with MegaTech RealEstate."
				keywords="Nigeria real estate, buy property, rent house, Abakaliki properties, real estate marketplace"
			/>
							...
							{featured?.map((featured) => (
								<SwiperSlide key={featured._id}>
									<div
										...
										style={{
											backgroundImage: `url(${featured.imageUrls[0]})`,
										}}>
										<motion.div
					...
					<div className="row align-items-center justify-content-center">
						<div className="col-lg-6 md-mb-50px position-relative">
							<figure className="position-relative mb-0 overflow-hidden border-radius-6px">
								<img src={megaflier} alt="" className="w-100" />
											...
											<div className="bg-white">
												<div className="content ps-40px pe-40px pt-35px pb-35px md-p-25px border-bottom border-color-transparent-dark-very-light">
													<div className="d-flex align-items-center">
														<span className="alt-font text-dark-gray fw-800 fs-22 me-10px uppercase">
															{prop.title}
														</span>
													</div>

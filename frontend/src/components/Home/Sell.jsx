...
const Sell = () => {
	...
	return (
		<div>
			<SEO
				title="Properties for Sale - Buy Houses, Land & Commercial Property"
				description="Browse properties for sale in Nigeria. Find houses, apartments, lands and commercial properties to buy."
				keywords="buy property Nigeria, houses for sale, land for sale, real estate for sale"
			/>
			{/*  start page title  */}
									...
									<div className="col mb-30px">
										<div className="border-radius-6px overflow-hidden box-shadow-large">
											<div className="image position-relative">
												...
												<div className="col-auto bg-base-color border-radius-50px ps-15px pe-15px text-uppercase alt-font fw-600 text-white fs-12 lh-24 position-absolute left-20px top-20px">
													{prop.propertyType}
												</div>
											</div>

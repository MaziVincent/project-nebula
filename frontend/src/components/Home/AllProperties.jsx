...
const AllProperties = () => {
	...
	return (
		<div>
			<SEO
				title="All Properties - Buy & Sell Real Estate"
				description="Browse all available properties for sale and rent. Find houses, apartments, lands, and commercial properties in Nigeria."
				keywords="properties for sale, real estate listings, buy property Nigeria, rent apartment"
			/>
			{/*  start page title  */}
				...
				<div className="container-fluid">
					<div className="row overlap-height">
						<div className="col-12 p-0 position-relative overlap-gap-section">
							...
							<div
								className="alt-font fw-600 text-[250px] lg-fs-275 md-fs-250 xs-fs-160 position-absolute right-minus-170px lg-right-0px bottom-50px md-bottom-minus-60px xs-bottom-minus-50px text-white text-outline ls-minus-5px lg-right-0px text-outline-width-2px z-index-2"
			...
			<section className="bg-very-light-gray z-index-3 position-relative">
				<div className="container">
							...
							<div className="bg-white h-100 box-shadow-quadruple-large box-shadow-medium-hover border-radius-6px pt-25px pb-25px ps-40px pe-40px lg-p-25px">
								...
								<div className="feature-box feature-box-left-icon-middle text-start">
									...
									<div className="feature-box-icon me-0">
										<img
											src="images/demo-real-estate-icon-apartment.svg"
											alt=""
										/>
									</div>
								</div>
					...
					{isError && <p>Error Fetching Propeties</p>}
				...
				<div className="container overlap-gap-section">
					<div className="row align-items-center">
						<div className="col-xl-5 col-lg-6 md-mb-50px">
							<span className="fs-20 d-inline-block mb-15px text-base-color">
								How it works property marketplace
							</span>
							<h2
								className="alt-font fw-500 text-dark-gray ls-minus-1px shadow-none sm-w-80 xs-w-100"
								data-shadow-animation="true"
								data-animation-delay="700">
								Step for buying a{" "}
								<span className="fw-700 text-highlight">
							...
							<div className="row row-cols-1 mt-50px">
									...
									<div className="process-step-item d-flex">
										...
										<div className="process-content ps-35px last-paragraph-no-margin mb-30px">
											...
											<p className="w-80 lg-w-100">
												Navigate through our list of available properties to
												find the one you want to buy or rent.
											</p>
										</div>
									</div>
								</div>
								...
								<div className="col-12 process-step-style-05 position-relative hover-box">
									<div className="process-step-item d-flex">
										...
										<div className="process-content ps-35px last-paragraph-no-margin mb-30px">
											...
											<p className="w-80 lg-w-100">
												Choose the property that best fits your budget from our
												extensive selection of appealing properties.
											</p>
										</div>
									</div>
								</div>
								...
								<div className="col-12 process-step-style-05 position-relative hover-box">
									<div className="process-step-item d-flex">
										...
										<div className="process-content ps-35px last-paragraph-no-margin mb-30px">
											<span className="text-dark-gray fs-19 alt-font mb-5px fw-600 d-block">
												Proceed to get your property
											</span>
											<p className="w-80 lg-w-100">
												{" "}
												View property details to get in touch with the owner.
											</p>
										</div>
									</div>
								</div>
					...
					<div className="row justify-content-center align-items-center mt-50px">
						<div className="col-12 text-center align-items-center">
							<div className="bg-white border border-1 border-color-extra-medium-gray box-shadow-extra-large alt-font fs-12 fw-700 text-dark-gray text-uppercase border-radius-30px ps-20px pe-20px me-10px sm-me-0 sm-m-5px d-inline-block align-middle">
								Fun facts
							</div>
							<div className="fs-22 text-dark-gray d-block d-sm-inline-block align-middle alt-font fw-600">

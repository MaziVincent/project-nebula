...
const AgentMessage = () => {
	...
	return (
		<div className="min-h-dvh">
			<div>
				<div className="px-4">
					<h1 className="text-center text-2xl py-4 font-bold text-gray-700">
						Messages
					</h1>
					<button
					...
					{isSuccess && (
						<div className="">
							{data?.messages?.map((message) => (
								<Link
									to={`/agent/message/${message._id}`}
									key={message._id}
									className="flex justify-start gap-2 items-start shadow-md mt-4 p-2">
									<div className="">
										<img
									...
									<div>
										<h2 className="text-xl font-semibold mb-0 text-gray-500">
											Name:{" "}

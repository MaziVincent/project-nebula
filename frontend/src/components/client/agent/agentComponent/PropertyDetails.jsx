...
const PropertyDetails = () => {
	...
	const handleOpenImageDelete = () => setOpenImageDelete(true);
	const handleCloseImageDelete = () => setOpenImageDelete(false);
	...
	return (
		<div>
			...
			{!property ? (
				...
				<div className="">
					...
					<div className="mt-2">
						...
						<div className=" grid grid-cols-3 gap-3 shadow-md duration-200 delay-100 ease-in-out">
							{property.imageUrls.map((imageUrl, index) => (
								<div className="border-2 relative hover:scale-105" key={index}>
									<span
										onClick={() => handleImageDelete(imageUrl)}
										className="absolute cursor-pointer top-2 right-2 text-red-500    ">
										<svg
											className="w-7 h-7 text-red-500 hover:text-red-700 hover:scale-150"
											aria-hidden="true"
											xmlns="http://www.w3.org/2000/svg"
											width="24"
											height="24"
						...
						<p className=" text-2xl text-center text-gray-600 font-medium">
							Other Features:
						</p>
						<div>
											...
											{property.landFeatures.map((landFt, index) => (
												<li
													...
													<div
														...
														dangerouslySetInnerHTML={{ __html: landFt }}
													/>
												</li>
											))}
										</ul>
					...
					<div className=" flex justify-start items-start gap-4 my-4 ">
						...
						{(property.type === "Land" || property.type === "House") && (
			...
			<DeleteImageModal
				...
				handleClose={handleCloseImageDelete}

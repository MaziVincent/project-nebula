...
const AgentOverview = () => {
  ...
  const getProperties = async () => {
    const response = await fetch(`${url}/${agentId}?page=${page}&limit=10`, auth.accessToken);
  ...
  return (
    <div className=" h-dvh">
     {isLoading && <div className="flex justify-center items-center my-20"><CircularProgress /></div>}
     {
      isSuccess &&
      <div>
        <h1 className=" text-2xl font-light text-start text-green-900 py-5">Agent Overview</h1>
        <div>

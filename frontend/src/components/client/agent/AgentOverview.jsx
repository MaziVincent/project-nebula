    ...
    <div>
      {
        isLoading ? (
          ...
          <div>
            <h1 className=" text-2xl font-light text-start text-green-900">Agent Overview</h1>
            <div>
      ...
      <NewShopModal open={openShopModal} handleCloseShopModal={handleCloseShopModal} />
      <PropertyStatusModal openStatus={openStatus} handleCloseStatus={handleCloseStatus} property={propertyStatus} />
      <DeletePropertyModal

    ...
    >
      <div className="overflow-y-auto py-5 px- h-full bg-white max-sm:mt-6">
        <ul className="space-y-4 pl-0 pr-4">
          ...
          <li className="">
            <Link to='/dashboard/messages/sent' className={`flex items-center border-l-4 border-gray-50 hover:border-green-500 p-2 text-base font-medium text-gray-900 rounded-r-lg  hover:bg-gray-100 ${location.pathname === '/dashboard/messages/sent' ? 'border-green-500 text-green-500' : ''} hover:text-green-500 group`}>
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
                className={`w-7 h-7 ml-2 text-gray-500 transition duration-75 group-hover:text-green-900 ${location.pathname === '/dashboard/messages/sent' ? 'text-green-900' : ''}`}
                viewBox="0 -960 960 960"
                fill="currentColor">
        ...
        <button
          ...
          className="flex items-center border-l-4 w-full border-gray-50 hover:border-red-600 p-2 text-base font-medium text-red-500 hover:text-red-700 rounded-r-lg transition duration-75 hover:bg-gray-100 group mt-20"
        >
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            aria-hidden="true"

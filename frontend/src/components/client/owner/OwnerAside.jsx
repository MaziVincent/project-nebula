    ...
    >
      <div className="overflow-y-auto py-5 px- h-full bg-green-50 max-sm:mt-6">
        ...
        <ul className="pt-5 mt-5 pl-0 pr-4 space-y-4 border-t border-green-100">
          <li>
          <Link to='/owner/messages' className={`flex items-center border-l-4 border-gray-50 hover:border-green-500 p-2 text-base font-medium text-gray-900 rounded-r-lg  hover:bg-gray-100 ${location.pathname === '/owner/messages' ? 'border-green-500 text-green-500' : ''} hover:text-green-500 group`}>
              <svg 
                xmlns="http://www.w3.org/2000/svg" 
